...
//namespace Paykun\Pcheckout\Controller\Errors;

/**
 * Class ErrorCodes
 * @package Paykun\Checkout\Errors
 */
class Paykun_Pcheckout_Errors_ErrorCodesController {

    const INVALID_MERCHANT_ID_CODE      = 100;
    const INVALID_MERCHANT_ID_STRING    = "Merchant Id is missing or not valid";

    const INVALID_ACCESS_TOKEN_CODE     = 101;
    const INVALID_ACCESS_TOKEN_STRING   = "Access Token is missing or not valid";

    const INVALID_API_SECRETE_CODE      = 102;
    const INVALID_API_SECRETE_STRING    = "Api Secret is missing or not valid";
    ...
    const INVALID_SUCCESS_URL_STRING    = "Success Url is missing or not valid";

    const INVALID_FAIL_URL_CODE         = 107;
    const INVALID_FAIL_URL_STRING       = "Failure Url is missing or not valid";
